#!/usr/bin/env python3
"""
bdd-async Installer - Cross-platform
Verifies prerequisites for BDD workflow with TUnit
"""
...
def main():
    print_header("bdd-async Installer (Cross-platform)")
    ...
    print("2. Follow the BDD workflow in SKILL.md")
